...
public class VisitorGetUnlockedShortly implements Visitor {
  private final Logger logger =  LoggerFactory.getLogger("FITA2");
  private final ArrayList<Door> unlockedAreas = new ArrayList<>();

  public VisitorGetUnlockedShortly() {}
  ...
  public ArrayList<Door> getUnlockedAreas() {
